...
- Ni ska lämna in en inlämningsrapport i en markdown fil som
  heter [`personal_reflections.md`](documentation/personal_reflections.md) i mappen `documentation/answers`.

## Sista inlämningstid

Lämna in uppgiften senast den `2024-01-09` kl. `23:59:59`.
